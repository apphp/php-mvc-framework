...
(1, 'Simple Blog', 'your slogan here...', 'ApPHP Simple Blog &copy;', 300, 'Simple Blog', 'apphp framework, blog, apphp', 'ApPHP MicroBlog - Personal PHP Web Blog');
...
INSERT INTO `<DB_PREFIX>authors` (`id`, `login`, `password`, `email`, `about_text`, `avatar_file`) VALUES
(1, '<USERNAME>', '<PASSWORD>', '<EMAIL>', 'Hi! My name is Jack. I''m a programmer and I like music, sport, computers and many other... Enjoy with my personal blog!', 'admin_avatar.png');
