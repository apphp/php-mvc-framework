...
class CValidatorTest extends TestCase
{
	...
	public function testIsEmpty(): void
	{
		...
		self::assertEquals(true, CValidator::isEmpty(array()));
	...
	public function testIsAlpha(): void
	{
		...
		self::assertEquals(true, CValidator::isAlpha('ABCDE'));
		self::assertEquals(true, CValidator::isAlpha('ABcde'));
		self::assertEquals(true, CValidator::isAlpha('ABcde#', array('#')));
		self::assertEquals(true, CValidator::isAlpha('ABc de#', array(' ', '#')));
		...
		self::assertNotEquals(true, CValidator::isAlpha('ABc de#', array('#')));
	}
